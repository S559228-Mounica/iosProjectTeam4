...
extension Anchor where Type: AnchorType.Alignment {
    /// Aligns two anchors.
    @discardableResult func align<OtherType: AnchorType.Alignment>(with anchor: Anchor<OtherType, Axis>, relation: NSLayoutConstraint.Relation = .equal) -> NSLayoutConstraint {
...
extension Anchor where Type: AnchorType.Dimension {
    ...
    @discardableResult func match<OtherAxis>(_ anchor: Anchor<AnchorType.Dimension, OtherAxis>, relation: NSLayoutConstraint.Relation = .equal) -> NSLayoutConstraint {
        return Constraints.constrain(self, anchor, relation: relation)
    }
}
...
final class Constraints {
    ...
    internal static func constrain(item item1: Any, attribute attr1: NSLayoutConstraint.Attribute, relatedBy relation: NSLayoutConstraint.Relation = .equal, toItem item2: Any? = nil, attribute attr2: NSLayoutConstraint.Attribute? = nil, multiplier: CGFloat = 1, constant: CGFloat = 0) -> NSLayoutConstraint {
        ...
        _install(constraint: constraint)
        return constraint
    }
    ...
    private static func _install( constraint: NSLayoutConstraint) {
...
extension Anchor where Type: AnchorType.Alignment {
    ...
    @discardableResult func align<OtherType: AnchorType.Alignment>(with anchor: Anchor<OtherType, Axis>, offset: CGFloat = 0, multiplier: CGFloat = 1, relation: NSLayoutConstraint.Relation = .equal) -> NSLayoutConstraint {
...
extension Anchor where Type: AnchorType.Dimension {
    ...
    @discardableResult func match<OtherAxis>(_ anchor: Anchor<AnchorType.Dimension, OtherAxis>, offset: CGFloat = 0, multiplier: CGFloat = 1, relation: NSLayoutConstraint.Relation = .equal) -> NSLayoutConstraint {
        return Constraints.constrain(self, anchor, offset: offset, multiplier: multiplier, relation: relation)
    }
}
